...
public enum ErrorsEnum {
	...
	SAME_CPF("Client has the same CPF", "clientCpf", 100), SAME_RG("Client has the same RG", "clientRg", 101),
	...
	DIDNT_FIND_ACCOUNTS("Could not find any accounts", "accounts", 104);
